package jxrwxz.teachassistant.run;
...
public final class HackScanner implements Iterator<String>, Closeable {
     ...
     * @return this scanner
     */
    public jxrwxz.teachassistant.run.HackScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public jxrwxz.teachassistant.run.HackScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public jxrwxz.teachassistant.run.HackScanner useLocale(Locale locale) {
     ...
     */
    public jxrwxz.teachassistant.run.HackScanner useRadix(int radix) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public jxrwxz.teachassistant.run.HackScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public jxrwxz.teachassistant.run.HackScanner skip(String pattern) {
    ...
    /**
     * Scans the next token of the input as a {@link BigInteger
     * BigInteger}.
     *
     * <p> An invocation of this method of the form
    ...
    /**
     * Scans the next token of the input as a {@link BigDecimal
     * BigDecimal}.
     *
     * <p> If the next token matches the <a
     ...
     * digits via the {@link Character#digit Character.digit}, and passing the
     * resulting string to the {@link
     * BigDecimal#BigDecimal(String) BigDecimal(String)}
     * constructor.
     *
     ...
     * @since 1.6
     */
    public jxrwxz.teachassistant.run.HackScanner reset() {
