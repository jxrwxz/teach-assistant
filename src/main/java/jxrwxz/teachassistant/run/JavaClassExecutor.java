...
//    private static volatile AtomicInteger runningCount = new AtomicInteger(0);
    ...
    public static String execute(byte[] classByte, String systemIn) {
        ...
        // 3. 调用ClassModifier#modifyUTF8Constant修改
        byte[] modifyBytes = cm.modifyUTF8Constant("java/lang/System","jxrwxz/teachassistant/run/HackSystem");
        modifyBytes = cm.modifyUTF8Constant("java/util/Scanner", "jxrwxz/teachassistant/run/HackScanner");
